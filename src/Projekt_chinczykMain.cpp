...
Projekt_chinczykDialog::Projekt_chinczykDialog(wxWindow* parent,wxWindowID id)
{
    ...
    StaticBitmap1 = new wxStaticBitmap(this, ID_STATICBITMAP1, wxBitmap(wxImage(_T("assets/chinczyk-tytul.png"))), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICBITMAP1"));
