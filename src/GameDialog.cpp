...
GameDialog::GameDialog(wxWindow* parent,wxWindowID id)
{
	...
	BitmapButton1 = new wxBitmapButton(this, ID_BITMAPBUTTON1, wxBitmap(wxImage(_T("assets/tlo_sz.png"))), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_SIMPLE|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON1"));
	...
	StaticBitmap2 = new wxStaticBitmap(this, ID_STATICBITMAP2, wxBitmap(wxImage(_T("assets/green.png"))), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICBITMAP2"));
	...
	StaticBitmap1 = new wxStaticBitmap(this, ID_STATICBITMAP1, wxBitmap(wxImage(_T("assets/kostka_2.png"))), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICBITMAP1"));
	...
	BitmapButton4 = new wxBitmapButton(this, ID_BITMAPBUTTON4, wxBitmap(wxImage(_T("assets/tlo_sz.png"))), wxDefaultPosition, wxSize(0,300), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTON4"));
	...
	rysunki[0] = wxBitmap(wxImage("assets/green.png"));
	rysunki[1] = wxBitmap(wxImage("assets/red.png"));
	rysunki[2] = wxBitmap(wxImage("assets/yellow.png"));
	rysunki[3] = wxBitmap(wxImage("assets/blue.png"));
	rysunki[4] = wxBitmap(wxImage("assets/tlo_sz.png"));
	rysunki[5] = wxBitmap(wxImage("assets/tlo_b.png"));

	pionki[0] = wxBitmap(wxImage("assets/pion_g.png"));
	pionki[1] = wxBitmap(wxImage("assets/pion_r.png"));
	pionki[2] = wxBitmap(wxImage("assets/pion_y.png"));
	pionki[3] = wxBitmap(wxImage("assets/pion_b.png"));

	pionki2[0] = wxBitmap(wxImage("assets/pion_g2.png"));
	pionki2[1] = wxBitmap(wxImage("assets/pion_r2.png"));
	pionki2[2] = wxBitmap(wxImage("assets/pion_y2.png"));
	pionki2[3] = wxBitmap(wxImage("assets/pion_b2.png"));

	pionki3[0] = wxBitmap(wxImage("assets/pion_g3.png"));
	pionki3[1] = wxBitmap(wxImage("assets/pion_r3.png"));
	pionki3[2] = wxBitmap(wxImage("assets/pion_y3.png"));
	pionki3[3] = wxBitmap(wxImage("assets/pion_b3.png"));

	pionki4[0] = wxBitmap(wxImage("assets/pion_g4.png"));
	pionki4[1] = wxBitmap(wxImage("assets/pion_r4.png"));
	pionki4[2] = wxBitmap(wxImage("assets/pion_y4.png"));
	pionki4[3] = wxBitmap(wxImage("assets/pion_b4.png"));


	kostka[0] = wxBitmap(wxImage("assets/kostka_1.png"));
	kostka[1] = wxBitmap(wxImage("assets/kostka_2.png"));
	kostka[2] = wxBitmap(wxImage("assets/kostka_3.png"));
	kostka[3] = wxBitmap(wxImage("assets/kostka_4.png"));
	kostka[4] = wxBitmap(wxImage("assets/kostka_5.png"));
	kostka[5] = wxBitmap(wxImage("assets/kostka_6.png"));
